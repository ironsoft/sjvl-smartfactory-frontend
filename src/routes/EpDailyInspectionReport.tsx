    ...
    <Box mt={4} pt={3} borderTop="1px dashed" borderColor={thumbBorder}>
      <HStack mb={3} spacing={1}>
        ...
        <Text
          ...
          letterSpacing="wide"
        >
          {t("epDailyInspectionReport.defectPhotos", { count: previews.reduce((acc, p) => acc + p.photo_image_ids.length, 0) })}
        </Text>
      </HStack>
            ...
            <Box key={preview.inspection_id}>
              ...
              <HStack mb={2} spacing={2}>
                ...
                <Badge colorScheme="orange" variant="subtle" fontSize="xs">
                  {t("epDailyInspectionReport.defectCount", { count: preview.defect_qty })}
                </Badge>
              </HStack>
      ...
      >
        ...
        <VStack align="flex-end" spacing={0} flexShrink={0} minW="110px">
          ...
          <Badge colorScheme={rateScheme} fontSize="xs">
            {row.defect_rate.toFixed(1)}% · {row.record_count}{t("epDailyInspectionReport.unitRecord")}
          </Badge>
        </VStack>
          ...
          {row.defect_categories.length > 0 ? (
            <TableContainer>
              <Table size="sm" variant="simple">
                <Thead>
                  <Tr>
                    <Th fontSize="xs">{t("epDailyInspectionReport.colDefectType")}</Th>
                    <Th isNumeric fontSize="xs">{t("epDailyInspectionReport.defectQty")}</Th>
                    <Th fontSize="xs">{t("epDailyInspectionReport.trend")}</Th>
                  </Tr>
                </Thead>
                <Tbody>
            ...
            <Text fontSize="xs" color="green.400" fontWeight="semibold">
              {t("epDailyInspectionReport.noDefects")}
            </Text>
          )}
  ...
  return (
    ...
    >
      <Text
        ...
        mb={4}
      >
        {t("epDailyInspectionReport.defectCategoryTitle")}
      </Text>
          ...
          <Box position="relative" mb={4}>
            ...
            >
              ...
              <Text
                ...
                letterSpacing="wide"
              >
                {t("epDailyInspectionReport.totalDefect")}
              </Text>
            </Box>
          </Box>
...
export default function EpDailyInspectionReport() {
  ...
  const { data, isLoading } = useQuery({
    queryKey: ["ep-daily-inspection-report", selectedDate],
    queryFn: () => getEpDailyInspectionReport(selectedDate)
  });
  ...
  return (
    <Box minH="100vh" bg={pageBg} px={{ base: 4, md: 8 }} py={6}>
      <Helmet>
        <title>EP Daily Inspection Report | Sungjin MES</title>
      </Helmet>
      ...
      <Flex justify="space-between" align="center" mb={6} flexWrap="wrap" gap={4}>
        <Box>
          <Heading size="lg" letterSpacing="tight">
            {t("epDailyInspectionReport.title")}
          </Heading>
          <Text fontSize="sm" color="gray.500" mt={1}>
            {t("epDailyInspectionReport.subtitle")}
          </Text>
        </Box>
          ...
          <VStack spacing={0} minW="120px" textAlign="center" px={2}>
            ...
            {isToday && (
              <Badge colorScheme="green" fontSize="2xs">
                {t("epDailyInspectionReport.today")}
              </Badge>
            )}
          </VStack>
          <IconButton
      ...
      {isLoading ? (
        ...
        <Center minH="40vh">
          <Text color="gray.400">{t("epDailyInspectionReport.noData")}</Text>
        </Center>
      ) : (
        <>
          {/* ── KPI Cards ─────────────────────────────────────────── */}
          ...
          >
            <KpiCard
              ...
              subLabel={t("epDailyInspectionReport.kpi.totalInspectedSub")}
              accent="blue.400"
            />
            <KpiCard
              ...
              subLabel={t("epDailyInspectionReport.kpi.totalDefectSub")}
              accent="red.400"
            />
            ...
            >
              ...
              <Stat>
                <StatLabel
                  ...
                  letterSpacing="wide"
                >
                  {t("epDailyInspectionReport.kpi.defectRate")}
                </StatLabel>
                <StatNumber
                  fontSize="2xl"
                  fontWeight="extrabold"
                ...
                <StatHelpText mb={0} fontSize="xs">
                  {data.kpi.defect_rate === 0
                    ? t("epDailyInspectionReport.kpi.defectRateGood")
                    : data.kpi.defect_rate < 2
                    ? t("epDailyInspectionReport.kpi.defectRateOk")
                    : data.kpi.defect_rate < 5
                    ? t("epDailyInspectionReport.kpi.defectRateWarn")
                    : t("epDailyInspectionReport.kpi.defectRateBad")}
                </StatHelpText>
              </Stat>
            </Box>
            <KpiCard
              ...
              subLabel={t("epDailyInspectionReport.kpi.recordCountSub")}
              accent="purple.400"
            />
            <KpiCard
              icon={<FaTags />}
              label={t("epDailyInspectionReport.kpi.activeStyles")}
              value={data.kpi.active_styles_count}
              animatedValue={animStyles}
              subLabel={t("epDailyInspectionReport.kpi.activeStylesSub")}
              accent="teal.400"
            />
            <KpiCard
              icon={<FaUser />}
              ...
              subLabel={t("epDailyInspectionReport.kpi.activeInspectorsSub")}
              accent="green.400"
            />
            <KpiCard
              icon={<FaClock />}
              ...
              subLabel={t("epDailyInspectionReport.kpi.peakHourSub")}
              accent="orange.400"
            />
          </Grid>
          ...
          >
            ...
            <Box>
              <Text
                ...
                mb={4}
              >
                {t("epDailyInspectionReport.byStyleTitle")}
              </Text>
              {data.by_style.length === 0 ? (
                ...
                >
                  <Text color="gray.400">
                    {t("epDailyInspectionReport.noData")}
                  </Text>
                </Center>
              ) : (
              ...
              {data.by_inspector.length > 0 && (
                ...
                >
                  <Text
                    ...
                    mb={4}
                  >
                    {t("epDailyInspectionReport.byInspectorTitle")}
                  </Text>
                  <TableContainer>
                    <Table size="sm" variant="simple">
                      <Thead>
                        <Tr>
                          <Th fontSize="xs">
                            {t("epDailyInspectionReport.inspector")}
                          </Th>
                          <Th isNumeric fontSize="xs">
                            {t("epDailyInspectionReport.inspectedQty")}
                          </Th>
                          <Th isNumeric fontSize="xs">
                            {t("epDailyInspectionReport.defectQty")}
                          </Th>
                          <Th isNumeric fontSize="xs">
                            {t("epDailyInspectionReport.defectRate")}
                          </Th>
                          <Th fontSize="xs">
                            {t("epDailyInspectionReport.trend")}
                          </Th>
                        </Tr>
                      </Thead>
                      <Tbody>
            ...
            >
              ...
              >
                <Text
                  ...
                  mb={5}
                >
                  {t("epDailyInspectionReport.hourlyTitle")}
                </Text>
                  ...
                  <ResponsiveContainer width="100%" height={220}>
                    ...
                    >
                      ...
                      <Bar
                        ...
                        name={t("epDailyInspectionReport.inspectedQty")}
                        fill="#4299E1"
                        radius={[3, 3, 0, 0]}
                      />
                      <Bar
                        dataKey="defect_qty"
                        name={t("epDailyInspectionReport.defectQty")}
                        fill="#FC8181"
                        radius={[3, 3, 0, 0]}
                      />
                    </BarChart>
