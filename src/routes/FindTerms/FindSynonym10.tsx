...
export default function FindSynonym10() {
  // 현재 페이지 상태 관리
  ...
  const onSelectTerm = (termId: number, languageType: string) => {
    ...
    window.opener.postMessage(
      // termId와 languageType를 부모창으로 전달
      // languageType은 synonym10으로 고정해서 여기서 선택한 값이 synonym_10에 들어가도록 함.
      { termId: termId, languageType: "synonym10" },
